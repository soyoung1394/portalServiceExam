...
public class JdbcContext {
    ...
    Long jdbcContextForInsert(StatmentStrategy statmentStrategy) throws SQLException {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        long id;
    ...
    void jdbcContextForUpdate(StatmentStrategy statmentStrategy) throws SQLException {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        try {
            connection = dataSource.getConnection();
    ...
    Product queryForObject(String sql, Object[] params) throws SQLException {
        ...
        return jdbcContextForGet(statmentStrategy);
    }
    ...
    Long insert(String sql, Object[] params) throws SQLException {
        ...
        return jdbcContextForInsert(statmentStrategy);
    }
    ...
    void update(String sql, Object[] params) throws SQLException {
        ...
        jdbcContextForUpdate(statmentStrategy);
    }
}